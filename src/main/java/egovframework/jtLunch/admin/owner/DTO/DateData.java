...
public class DateData {
	...
	MenuPlanDTO[] selectDayMenulist = new MenuPlanDTO[100];
	...
	public MenuPlanDTO[] getSelectDayMenulist() {
		return selectDayMenulist;
	}

	public void setSelectDayMenulist(MenuPlanDTO[] selectDayMenulist) {
		this.selectDayMenulist = selectDayMenulist;
	}
	...
	public DateData(String year, String month, String date, String value, MenuPlanDTO[] selectDayMenulist) {
